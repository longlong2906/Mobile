...
public class RecommendedMajorAdapter extends RecyclerView.Adapter<RecommendedMajorAdapter.ViewHolder> {

    private final Context context;
    private final List<Major> majors;

    public RecommendedMajorAdapter(Context context, List<Major> majors) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_recommended_major, parent, false);
